...
<html>
<head>
  <title>Klassenwebsite &ndash; Schreib was!</title>
...
<body>
  ...
  <main>
    ...
    <p style="font-family: 'Chivo Mono', monospace; color: #dd0000; text-align: left; font-size: 16px;">Live-Vorschau ist noch nicht verfügbar.</p>
    <div id="help-drafts">
      ...
      <div class="links">
        ...
        <a href="manual.php?show=drafts#drafts">Über Entwürfe<i class="fa-solid fa-angle-right"></i></a>
      </div>
    </div>
